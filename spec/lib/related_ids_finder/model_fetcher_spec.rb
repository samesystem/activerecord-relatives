...
RSpec.describe RelatedIdsFinder::ModelFetcher do
  ...
  let(:family_fetcher) { RelatedIdsFinder::ModelForcedFetcher.new(Family, ids: family_ids) }
  let(:message_fetcher) { RelatedIdsFinder::ModelForcedFetcher.new(Message, ids: [1, 2, 3]) }
